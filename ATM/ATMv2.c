...
void menu()
{
    ...
    case 3:
        ...
        while (getchar() != '\n');
        gets(name);
        i=buscarCuenta(Personas, 100 ,name);
        if(i!=-1){
...
void crear_cuenta(struct ATM Personas[], int cantidad)
{
    ...
    printf("Dame tu nombre (Empezando con mayuscula)\n");
    while (getchar() != '\n');
    gets(Personas[cantidad].Nombre);
    printf("Dame tu Apeliido (Empezando con mayuscula)\n");
